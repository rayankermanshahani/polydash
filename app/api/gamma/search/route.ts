...
import type { GammaPublicSearchQuery } from "@/lib/polymarket/gamma";
...
const parseSearchParams = (searchParams: URLSearchParams) => {
  ...
  return params as GammaPublicSearchQuery;
};
...
export async function GET(request: Request) {
  try {
    ...
    const data = await searchMarkets(params, { cache: "no-store" });
